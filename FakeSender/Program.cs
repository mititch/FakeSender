...
using Printio.Messaging.Client.Domain;
using Printio.Messaging.Client.Domain.Events;
...
namespace FakeSender
{
    ...
    public class Sender
    {
        private const String MQ_CONNECTION_STRING = "host=localhost;username=guest;password=guest";
